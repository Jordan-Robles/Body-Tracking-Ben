...
def run():
    ...
    try:
        while pygame_running:
            ...
            # Display pitch value
            font = pygame.font.Font(None, 36)
            elbow_text = font.render("Elbow: %d" % tracker.elbow_angle, True, (255, 255, 255))
            pygame_window.blit(elbow_text, (10, 70))
...
class KinectTracking(object):
    ...
    def skeleton_frame_ready(self, skeleton_frame):
        ...
        """
        if self.previous_elbow_angle < 0 and current_elbow_angle > 0:
            elbow_angle = -current_elbow_angle
            self.previous_elbow_angle = -current_elbow_angle
